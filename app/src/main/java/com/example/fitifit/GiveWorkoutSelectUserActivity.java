...
import com.example.fitifit.Adapter.UserWorkoutAdapter;
...
public class GiveWorkoutSelectUserActivity extends AppCompatActivity {

    private RecyclerView recyclerView;
    private UserWorkoutAdapter UserWorkoutAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_give_workout_select_user);
        ...
        UserWorkoutAdapter = new UserWorkoutAdapter(getBaseContext(), mUsers);
        recyclerView.setAdapter(UserWorkoutAdapter);
    ...
    private void UserSearch(String s) {
        ...
        sorgu.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                UserWorkoutAdapter.notifyDataSetChanged();
            }
