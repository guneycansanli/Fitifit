...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent = getIntent();
        String id = "CgMfIiy9qMh3tMeUZfg6k7saafi2";     //intent.getStringExtra("id");
        ...
        reference = FirebaseDatabase.getInstance().getReference("Dieticians").child(id);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (user.getImage().equals("default")) {
                    profile_photo.setImageResource(R.drawable.app_account_image);
                } else {
                    Glide.with(MessageActivity.this).load(user.getImage()).into(profile_photo);
                }

                readMessages(fuser.getUid(), id ,user.getImage());
            }
